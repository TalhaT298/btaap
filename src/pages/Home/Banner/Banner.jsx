  ...
  return (
    <React.Fragment>
      <div className="flex flex-col lg:flex-row w-full">
        {/* Left Side (80%) */}
        <div className="lg:w-4/5 relative w-full">
          <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-extrabold absolute top-6 left-6 p-4" style={{ fontFamily: "Ubuntu, sans-serif", fontWeight: 400 }}>
        ...
        {/* Right Side (20%) */}
        <div className="lg:w-1/5 flex flex-col space-y-4 p-4 w-full">
          {/* First Box */}
