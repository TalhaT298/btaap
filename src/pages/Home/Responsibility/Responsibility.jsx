    ...
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="relative">
          <img src={sc} alt="Image 1" className="w-full h-auto rounded-3xl" />
        ...
        <div className="relative">
          <img src={tree} alt="Image 2" className="w-full h-auto rounded-3xl" />
        ...
        <div className="relative">
          <img src={coin} alt="Image 3" className="w-full h-auto rounded-3xl" />
