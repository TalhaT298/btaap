...
const Footer = () => {
  return (
    <React.Fragment>
      ...
      >
        <div>
          <h3 className="font-bold text-2xl sm:text-3xl mb-4 text-center sm:text-left">
            Today's{" "}
            <span className="" style={{ color: "#97ce9b" }}>
              Btaap
            </span>
          </h3>
        </div>
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          {/* Btaap Service */}
          <div>
            <h3 className="font-bold text-lg sm:text-xl mb-4">Btaap Service</h3>
            <ul className="space-y-2 text-gray-500">
              <li>Communication</li>
              <li>Business</li>
              <li>Life</li>
          ...
          {/* Btaap Service Duplicate */}
          <div>
            <h3 className="font-bold text-lg sm:text-xl mb-4 hidden sm:block">
              &nbsp;&nbsp;&nbsp;
            </h3>
            <ul className="space-y-2 text-gray-500">
              <li>Communication</li>
          ...
          {/* Group */}
          <div>
            <h3 className="font-bold text-lg sm:text-xl mb-4">Group</h3>
            <ul className="space-y-2 text-gray-500">
              ...
              <li className="cursor-pointer">Btaap Entertainment ↗</li>
            </ul>
          </div>

          {/* IR */}
          <div>
            <h3 className="font-bold text-lg sm:text-xl mb-4">IR</h3>
            <ul className="space-y-2 text-gray-500">
              ...
              <li className="cursor-pointer">Investor Events ↗</li>
              <li className="cursor-pointer">Disclosure Info ↗</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500">
              ...
              <li className="cursor-pointer">Btaap Customer Center ↗</li>
              <li className="cursor-pointer">Daum Customer Center ↗</li>
              <li className="cursor-pointer">Commerce Customer Center ↗</li>
